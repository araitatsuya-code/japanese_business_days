...
module JapaneseBusinessDays
  ...
  class BusinessDayCalculator
    ...
    def business_days_between(start_date, end_date)
      ...
      return -business_days_between(end_date, start_date) if start_date > end_date
    ...
    def add_business_days(date, days)
      ...
      # 負の日数の場合は減算として処理
      return subtract_business_days(date, -days) if days.negative?
      ...
      while remaining_days.positive?
        current_date += 1
        remaining_days -= 1 if business_day?(current_date)
      end
    ...
    def subtract_business_days(date, days)
      ...
      # 負の日数の場合は加算として処理
      return add_business_days(date, -days) if days.negative?
