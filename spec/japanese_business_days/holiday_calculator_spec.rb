...
RSpec.describe JapaneseBusinessDays::HolidayCalculator do
  ...
  describe "#holidays_in_year" do
    ...
    context "with invalid year input" do
      ...
      it "raises InvalidArgumentError for year too large" do
        expect { calculator.holidays_in_year(10_000) }.to raise_error(JapaneseBusinessDays::InvalidArgumentError)
      end
    end
  end
  ...
  describe "error handling" do
    ...
    it "handles date parsing errors gracefully" do
      expect do
        calculator.holiday?("not-a-date")
      end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Invalid date string/)
    end
  end
end
