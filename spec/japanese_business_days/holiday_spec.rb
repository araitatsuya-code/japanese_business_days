  ...
  describe '#initialize' do
    ...
    context 'with invalid date' do
      it 'raises InvalidArgumentError for non-Date object' do
        ...
        }.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Date must be a Date object/)
      end
    ...
    context 'with invalid name' do
      it 'raises InvalidArgumentError for non-string name' do
        ...
        }.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Name must be a non-empty string/)
      end
    ...
    context 'with invalid type' do
      it 'raises InvalidArgumentError for invalid symbol' do
        ...
        }.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Type must be one of/)
      end
