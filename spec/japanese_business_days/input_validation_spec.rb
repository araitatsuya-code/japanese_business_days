  ...
  describe "nil argument validation" do
    describe ".business_days_between" do
      it "raises InvalidArgumentError when start_date is nil" do
        ...
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /start_date cannot be nil/)
      end

      it "raises InvalidArgumentError when end_date is nil" do
        expect do
          JapaneseBusinessDays.business_days_between(Date.new(2024, 1, 1), nil)
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /end_date cannot be nil/)
      end
    ...
    describe ".business_day?" do
      it "raises InvalidArgumentError when date is nil" do
        ...
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /date cannot be nil/)
      end
    end
    ...
    describe ".holidays_in_year" do
      it "raises InvalidArgumentError when year is nil" do
        ...
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /year cannot be nil/)
      end
    end
    ...
    describe ".add_business_days" do
      ...
      it "raises InvalidArgumentError when days is nil" do
        ...
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /days cannot be nil/)
      end
    end
      ...
      describe ".holidays_in_year" do
        it "raises InvalidArgumentError for invalid year types" do
          invalid_integer_types.each do |invalid_year|
            ...
            end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /must be an Integer/)
          end
        end
      end
    ...
    describe ".business_days_between" do
      it "raises InvalidArgumentError for empty date strings" do
        empty_strings.each do |empty_string|
          ...
          end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Date string cannot be/)
        end
      end
      ...
      it "raises InvalidDateError for invalid date strings" do
        invalid_date_strings.each do |invalid_string|
          ...
          end.to raise_error(JapaneseBusinessDays::InvalidDateError, /Invalid date/)
        end
      end
    end
  ...
  describe "year range validation" do
    describe ".holidays_in_year" do
      it "raises InvalidArgumentError for year below 1000" do
        ...
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Year must be between 1000 and 9999, got 999/)
      end

      it "raises InvalidArgumentError for year above 9999" do
        expect do
          JapaneseBusinessDays.holidays_in_year(10_000)
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Year must be between 1000 and 9999, got 10000/)
      end
  ...
  describe "configuration validation" do
    describe ".configure" do
      it "raises InvalidArgumentError when no block is given" do
        ...
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Configuration block is required/)
      end
      ...
      it "wraps configuration errors in ConfigurationError" do
        ...
        end.to raise_error(JapaneseBusinessDays::ConfigurationError, /Configuration failed/)
      end
  ...
  describe "Configuration class validation" do
    ...
    describe "#add_holiday" do
      ...
      it "raises InvalidArgumentError for empty date strings" do
        expect do
          config.add_holiday("")
        end.to raise_error(JapaneseBusinessDays::InvalidArgumentError, /Date string cannot be empty/)
      end
