  ...
  describe 'Error classes' do
    ...
    describe 'JapaneseBusinessDays::InvalidDateError' do
      ...
      it 'has correct initialization parameters' do
        expect { JapaneseBusinessDays::InvalidDateError.new("test", invalid_date: "test", expected_format: "YYYY-MM-DD") }.not_to raise_error
      end
    end
    ...
    describe 'JapaneseBusinessDays::InvalidArgumentError' do
      ...
      it 'has correct initialization parameters' do
        expect { JapaneseBusinessDays::InvalidArgumentError.new("test", parameter_name: "param", received_value: 123, expected_type: String) }.not_to raise_error
      end
    end
    ...
    describe 'JapaneseBusinessDays::ConfigurationError' do
      ...
      it 'has correct initialization parameters' do
        expect { JapaneseBusinessDays::ConfigurationError.new("test", config_key: "key", config_value: "value") }.not_to raise_error
      end
    end
  end
